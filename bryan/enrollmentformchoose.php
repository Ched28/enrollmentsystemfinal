...
?>
       ...
       <main>
                ...
                <form>
                    ...
                    <button type="button" name=" " onclick="location.href='Irregularformchoose.php?id=<?php echo $id?>' " style="background-color: #3366CC"> Irregular Student (Freshman(Transferees) and Returnees) </button> 
