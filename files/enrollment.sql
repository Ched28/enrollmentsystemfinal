...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2021 at 06:04 PM
...
INSERT INTO `course` (`id`, `coursename`, `course_code`, `courseshort`) VALUES
(1, 'BACHELOR OF SCIENCE IN INFORMATION TECHNOLOGY', 'IT', 'BSIT'),
(2, 'BACHELOR OF SCIENCE IN ENTREPRENEURSHIP', 'EN', 'BSEntrep'),
(3, 'BACHELOR OF SCIENCE IN INDUSTRIAL ENGINEERING', 'IE', 'BSIE'),
(4, 'BACHELOR OF SCIENCE IN ELECTRONICS ENGINEERING', 'EE', 'BSECE'),
(5, 'BACHELOR OF SCIENCE IN ACCOUNTANCY', 'AC', 'BSA');

-- --------------------------------------------------------

--
-- Table structure for table `enrollmentconfiguration`
--

CREATE TABLE `enrollmentconfiguration` (
  `id` int(11) NOT NULL,
  `academicyearfrom` date NOT NULL,
  `academicyearto` date NOT NULL,
...
--
-- Indexes for table `enrollmentconfiguration`
--
ALTER TABLE `enrollmentconfiguration`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `enrollmentconfiguration`
--
ALTER TABLE `enrollmentconfiguration`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
