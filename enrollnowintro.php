...
<tr> 
  ...
  <td> <button type="button" style="background-color:  #00AC17" onclick="location.href='update_intro.php'"> <i class="fas fa-folder-plus"></i> &nbsp; Update your Documents </button> </td>
